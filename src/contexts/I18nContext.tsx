...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    'login.emailPlaceholder': 'physicist@cern.ch or quantum_physicist',
  ...
  bg: {
    ...
    'index.cta.desc': 'Виж кой владее квантовия свят, и се цели във върха!',
    ...
    'login.welcomeBack': 'Добре дошъл отново',
      'login.email': 'Имейл или потребителско име',
      'login.password': 'Парола',
      'login.emailPlaceholder': 'physicist@cern.ch или quantum_physicist',
